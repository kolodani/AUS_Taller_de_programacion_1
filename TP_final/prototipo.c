...
void adivinar_palabra(char *, char *, int *, char (*)[MAX_LETRAS], int, int *);
...
void mostrar_palabras(char (*)[MAX_LETRAS], int);
...
int main()
{
    ...
    char salida = 's';
    int pos[MAX_PARTIDA];
    int arreglo_de_soluciones[MAX_PARTIDA] = {0, 0, 0, 0, 0, 0, 0, 0};
    char palabra[MAX_LETRAS];
    char palabra_jugador[MAX_LETRAS];
    char arreglo_de_palabras[MAX_PALABRAS][MAX_LETRAS];
    ...
    mostrar_palabras(arreglo_de_palabras, cant_total_partidas_jugador);
    return 0;
}
...
void adivinar_palabra(char *palabra, char *p_jugador, int *puntajes, char arreglo_de_palabras[][MAX_LETRAS], int partida, int *solucion)
{
    ...
    for (i = 0; i < MAX_INTENTOS; i++)
    {
        ...
        scanf(" %s", p_jugador);
        printf("> ");
        strcpy(arreglo_de_palabras[(partida * MAX_INTENTOS) + i], p_jugador);
